...
modules = ['idmtools_core', 'idmtools_cli', 'idmtools_platform_comps',
           'idmtools_models', 'idmtools_test', 'idmtools_platform_general',
           'idmtools_platform_slurm', 'idmtools_platform_container']
