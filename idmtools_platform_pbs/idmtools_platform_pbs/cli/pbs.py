"""
idmtools PBSPlatform CLI commands.
...
from idmtools_platform_pbs.utils.job_history import JobHistory
from idmtools_platform_pbs.utils.status import summarize_status_files, get_simulation_status
from idmtools_platform_pbs.utils.general import convert_byte_size, format_timestamp
...
class CustomGroup(click.Group):
    """Custom Group class for PBS Platform CLI commands."""
...
@click.group(cls=CustomGroup, allowed_commands=IMPORTANT_COMMANDS, short_help="PBS platform related commands.")
@click.option('--all', is_flag=True, help="Show all commands")
def pbs(all):
    """
    PBS Platform CLI commands.
...
@pbs.command(help="Check the status of an Experiment/Simulation.\n\n"
                        "Arguments:\n\n"
...
@pbs.command(help="List running Experiment/Simulation jobs.\n\n"
                        "Arguments:\n\n"
...
@pbs.command(help="Retrieve Experiment history.\n\n"
                        "Arguments:\n\n"
...
@pbs.command(help="View the job history.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID")
@click.argument('container-id', required=False)
...
@pbs.command(help="Locate Suite/Experiment/Simulation file directory.\n\n"
                        "Arguments:\n\n"
...
@pbs.command(help="Check if an Experiment/Simulation is running.\n\n"
                        "Arguments:\n\n"
...
@pbs.command(help="Check the history volume.")
def volume():
...
@pbs.command(help="Clear the job history.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID (optional)")
@click.argument('container-id', required=False)
...
@pbs.command(help="Sync the file system with job history.")
def sync_history():
    """Sync file system with job history."""
    JobHistory.sync()


@pbs.command(help="Get the count of count histories.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID (optional)")
@click.argument('container-id', required=False)
...
@pbs.command(help="Clear job results files and folders.\n\n"
                        "Arguments:\n\n"
                        "  ITEM_ID: Experiment/Simulation ID")
@click.argument('item-id', type=str, required=True)
...
@pbs.command(help="Inspect a container.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID")
...
@pbs.command(help="Stop running container(s).\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID (optional)")
@click.argument('container-id', required=False)
...
@pbs.command(help="Remove stopped containers.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID (optional)")
@click.argument('container-id', required=False)
...
@pbs.command(help="pip install a package on a container.\n\n"
                        "Arguments:\n\n"
...
@pbs.command(help="List packages installed on a container.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID")
@click.argument('container-id', required=True)
...
@pbs.command(help="List running processes in a container.\n\n"
                        "Arguments:\n\n"
                        "  CONTAINER_ID: Container ID")
@click.argument('container-id', required=True)
...
@pbs.command(help="List all available containers.")
