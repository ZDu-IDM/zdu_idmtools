...
"""
The setup script for the idmtools_platform_pbs platform, for users who use the PBS platform for idmtools.
"""
...
setup(
    ...
    description="PBS platform for IDM-Tools",
    install_requires=requirements,
    long_description=readme,
    long_description_content_type="text/markdown",
    include_package_data=True,
    keywords='modeling, IDM',
    name='idmtools_platform_pbs',
    packages=find_packages(exclude=["tests"]),
    test_suite='tests',
    entry_points={"idmtools_platform": [
        "idmtools_platform_pbs = idmtools_platform_pbs.plugin_info:PBSPlatformSpecification"],
        "idmtools_cli.cli_plugins": ["pbs = idmtools_platform_pbs.cli.pbs:pbs"]
    },
